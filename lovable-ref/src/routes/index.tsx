    ...
    <header className="sticky top-0 z-50 border-b border-border/60 bg-background/80 backdrop-blur-xl">
      <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-4 sm:px-6">
        ...
        <nav className="hidden items-center gap-8 text-sm font-medium text-muted-foreground md:flex">
          ...
          <a href="#hot" className="hover:text-chalk transition">Hot Takes</a>
        </nav>
        <a
          href="#waitlist"
      ...
      <div className="mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:gap-20">
          ...
          <div className="relative aspect-[4/5] overflow-hidden rounded-sm border border-border">
            ...
            <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-background to-transparent p-6">
              ...
              <div className="mt-2 flex items-center gap-3 text-xs text-muted-foreground">
                ...
                <span>·</span>
                <span>23h 41m left on the door</span>
              </div>
            </div>
          </div>
        ...
        <div>
          ...
          <p className="mt-6 max-w-lg text-base text-muted-foreground">
            When your club wins, your locker room earns a time-limited Raid Window — the right to enter
          ...
          <ol className="mt-10 space-y-6">
            {[
              ...
              { t: "Window opens", d: "Your locker room gets a 24-hour raid window into the losing rival's room.", n: "02" },
