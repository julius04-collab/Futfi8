  ...
  return (
    <div>
      ...
      {showOtpVerification ? (
        ...
        >
          <div className="mb-1 text-[10px] font-mono uppercase tracking-[0.3em] text-purple-500">
            03 . VERIFY YOUR EMAIL
          </div>
          <h2
          ...
          >
            ...
            <span className="text-white">{email}</span>. Enter it below to
            secure your locker room access.
          </p>
          ...
          <div className="flex items-center justify-center gap-3">
            {otp.map((digit, i) => (
              <input
                ...
                className="h-12 w-12 rounded-lg border text-center text-xl font-bold outline-none transition-colors"
                style={{
                  background: 'rgb(24, 24, 27)',
                  color: '#fff',
                  borderColor: otpError ? 'rgba(255,107,107,0.4)' : 'rgb(39, 39, 42)',
                }}
                autoFocus={i === 0}
              />
            ))}
