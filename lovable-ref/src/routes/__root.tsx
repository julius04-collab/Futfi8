...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Locker rooms for every Premier League club. Win a match, raid your rival. The matchday-powered fan community built for the digital generation." },
      { name: "author", content: "Futfi8" },
      ...
      { name: "twitter:site", content: "@Futfi8" },
    ],
    links: [
